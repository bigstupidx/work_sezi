...
public class EnterRoomScript : MonoBehaviour
{
    ...
    void Start()
    {
		...
		//SocketEventHandle.getInstance().enterRoomResponse += enterRoomResponse;
...
//        watingPanel.gameObject.SetActive(false);
    ...
    private void loadPerfab(string perfabName)
    {
		...
		//panelCreateDialog.GetComponent<SeZiLogicScript>().joinToRoom(GlobalDataScript.roomJoinResponseData.playerList);
    }
}
