...
public class MicroPhoneInput : MonoBehaviour {  
   ...
   // AudioCallBack callbackTest;
	...
	{  
        ...
        //micInputNoticetext(GetClipData());
        byte[] temp = GetClipData();
        int sga = temp.Length;
        CustomSocket.getInstance().sendMsg(new MicInputRequest(temp));
	...
	public void micInputNotice(ClientResponse response){
        int uuid = response.uuidOnlyforChatMic;
        SeZiLogicScript gamepanel = GameObject.Find("Panel_GameShiZi(Clone)").GetComponent<SeZiLogicScript>();
       // gamepanel.ShowSpeakMicImage(uuid);
    ...
    public void micInputNoticetext(byte[] data)
    {
